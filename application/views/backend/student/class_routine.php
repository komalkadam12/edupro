...
?>
   <div class="row">
                    ...
                    <a href="<?php echo base_url();?>student/class_routine_print_view/<?php echo $class_id;?>/<?php echo $row['section_id'];?>" 
                        class="btn btn-info btn-rounded btn-xs pull-right" target="_blank">
