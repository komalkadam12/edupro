...
<a href="<?php echo base_url(); ?>teacher/message/message_read/<?php echo $row['message_thread_code']; ?>" class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active';?>"><img src="<?php echo $this->crud_model->get_image_url($user_to_show_type, $user_to_show_id); ?>" class="img-circle" draggable="false"/> <span><?php echo $this->db->get_where($user_to_show_type, array($user_to_show_type . '_id' => $user_to_show_id))->row()->name; ?><small class="text-success">
                    ...
                    <div class="chat-right-aside">
						...
						<li> <a href="<?php echo base_url(); ?>teacher/group_message"> 
						Group Chat
								...
								<li class="odd">
                                    ...
                                    <div class="chat-body">
                                        <div class="chat-text" style="border:-moz-border-radius: 1em 4em 1em 4em;border-radius: 1em 4em 1em 4em;display:inline-block;">
											...
											<a href="#" onclick="confirm_modal('<?php echo base_url();?>teacher/deleteMessageFunction/<?php echo $row['message_id'];?>/<?php echo $row['message_thread_code'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a>
...
jQuery.ajax({
type: "POST",
url: "<?php echo base_url(); ?>" + "teacher/message/send_reply/<?php echo $current_message_thread_code?>",
dataType: 'json',
