<!-- .chat-row -->
                ...
                <div class="col-sm-8">
                  ...
                  <a href="<?php echo site_url('teacher/group_message/group_message_read/'.$row['group_message_thread_code']); ?>" class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['group_message_thread_code']) echo 'active'; ?>">
...
<a href="#" class="customize_group" onclick="showAjaxModal('<?php echo site_url('modal/popup/group_info/'.$row['group_message_thread_code']);?>');">view</a>
                    ...
                    <div class="chat-right-aside">
						...
						<li> <a href="<?php echo base_url(); ?>teacher/message"> 
						Personal Message
               
            			</a></li>
						
						<li><a href="<?php echo base_url(); ?>teacher/message/message_new">
                		Send New Chat
								...
								<li class="odd">
                                    ...
                                    <div class="chat-body">
                                        <div class="chat-text" style="border:-moz-border-radius: 1em 4em 1em 4em;border-radius: 1em 4em 1em 4em;display:inline-block;">
											...
											<a href="#" onclick="confirm_modal('<?php echo base_url();?>teacher/deleteMessageFunctionGroup/<?php echo $row['group_message_id'];?>/<?php echo $row['group_message_thread_code'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a>
...
jQuery.ajax({
type: "POST",
url: "<?php echo base_url(); ?>" + "teacher/group_message/send_reply/<?php echo $current_message_thread_code?>",
dataType: 'json',
