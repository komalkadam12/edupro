...
foreach ($edit_data as $row):
    $user = $this->db->get_where('teacher', array('teacher_id' => $row['teacher_id']))->row();
    ...
    <a onClick="PrintElem('#payroll_print')" class="btn btn-info btn-rounded btn-sm hidden-print">
