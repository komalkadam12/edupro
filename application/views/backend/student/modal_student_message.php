    ...
    <?php echo form_open(base_url() . 'student/message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
		...
		<img src="<?php echo $this->crud_model->get_image_url('student' , $row['student_id']);?>" class="img-circle" width="100" height="100" />
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-12">
					<textarea name="message" class="form-control textarea_editor" rows="5"  placeholder= "Please type your new message here for the selected student to read."></textarea>
						</div>
						</div>
