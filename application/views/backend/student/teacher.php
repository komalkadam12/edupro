<div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
<a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_teacher_message/<?php echo $row['teacher_id']; ?>');"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-envelope"></i></button></a>
							</td>
