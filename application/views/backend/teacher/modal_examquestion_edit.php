...
?>
                    ...
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('edit_examquestion');?></div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body table-responsive">

                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>teacher/examquestion/do_update/<?php echo $row['examquestion_id'] ?>" method="post" enctype="multipart/form-data">

                       	<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase('select_date');?></label>
                    <div class="col-sm-12">
                               
		<input type="date" name="timestamp" value="<?php echo $row['timestamp']; ?>" class="form-control datepicker" id="example-date-input" required>
		...
		<input type="hidden" class="form-control" name="teacher_id" value="<?php echo $row['teacher_id'];?>" data-validate="required">
               ...
               <select name="subject_id" class="form-control" id="subject_selector_holder">
                    ...
                    <div class="col-sm-12">
                             ...
                             <option value="Disapproved"<?php if ($row['status'] == 'Disapproved') echo 'selected'; ?>><?php echo get_phrase('Disapproved'); ?></option>
                                </select>
                            </div>
                        </div>
                       ...
                       <div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-info btn-sm btn-rounded"><i class="fa fa-edit"></i>&nbsp;<?php echo get_phrase('update_question');?></button>
						</div>
					</div>
                    </form>
