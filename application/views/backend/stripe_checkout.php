...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url('optimum/payment/css/stripe.css');?>"
            rel="stylesheet">
    </head>
    <body>
...
<!--required for getting the stripe token-->
        ...
        <img src="<?php echo base_url('uploads/logo.png');?>" width="25%;"
            ...
            <form method="post"
              ...
              <button type="submit">
                  <?php echo get_phrase('pay');?> $<?php echo $invoice_details;?>
              </button>
              <div class="outcome">
              ...
              <div class="package-details">
                  ...
                  <?php echo get_phrase('package');?> : <?php echo $package;?> <br>
              </div>
        ...
        <script src="<?php echo base_url('optimum/payment/js/stripe.js');?>"></script>
