...
<head>
    ...
    <link href="<?php echo base_url('optimum/payment/css/paypal.css');?>"
          rel="stylesheet">
</head>
<body>
<?php
...
<div class="package-details">
    ...
    <strong><?php echo get_phrase('due');?> : <?php echo $invoice_details;?></strong> <br>
    <?php echo get_phrase('title');?> : <?php echo $package;?> <br>
    ...
    paypal.Button.render({
        ...
        payment: function(data, actions) {
            return actions.payment.create({
                payment: {
                    transactions: [
                        {
                            amount: { total: '<?php echo $invoice_details;?>', currency: 'USD' }
                        }
                    ]
                }
            });
        ...
        onAuthorize: function(data, actions) {
            ...
            return actions.payment.execute().then(function() {
                ...
                $.ajax({
                   url: '<?php echo site_url($user_type . '/pay/paypal/' . $invoiceid->invoice_id);?>'
                }).done(function () {
