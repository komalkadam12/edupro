<div class="row">
                    ...
                    <div class="panel-heading"><?php echo get_phrase('payment_history');?></div>
        ...
        <ul class="nav nav-tabs bordered"><!-- available classes "bordered", "right-aligned" -->
            <li class="active">
                <a href="#opened" data-toggle="tab">
                    ...
                    <?php echo get_phrase('support_ticket_opened');?></span>
                </a>
            </li>
            <li class="">
                <a href="#closed" data-toggle="tab">
                    <span><i class="entypo-archive"></i>
                    <?php echo get_phrase('support_ticket_closed');?></span>
                </a>
            </li>
        </ul>
